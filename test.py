...
# print obj.create_contactlist(
# address='yo@dharwinperez.com',name='Sparky-Children')
# Add contact to list
# print obj.add_contact_to_list(
# contact_id = obj.currentUser, list_id = obj.currentList )
